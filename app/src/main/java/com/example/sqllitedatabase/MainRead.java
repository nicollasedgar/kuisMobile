...
public class MainRead extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListMahasiswa.clear();
        List<Mahasiswa> contacts = db.ReadPaduanSuara();
        for (Mahasiswa cn : contacts) {
            Mahasiswa judulModel = new Mahasiswa();
            judulModel.set_id(cn.get_id());
            judulModel.set_nama(cn.get_nama());
            judulModel.set_suara(cn.get_suara());
            judulModel.set_jabatan(cn.get_jabatan());
    ...
    public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
        ...
        String Ssuara = obj_itemDetails.get_suara();
        String Sjabatan = obj_itemDetails.get_jabatan();
        Intent goUpdel = new Intent(MainRead.this, MainUpdel.class);
        goUpdel.putExtra("Iid", Sid);
        goUpdel.putExtra("Inama", Snama);
        goUpdel.putExtra("Isuara", Ssuara);
        goUpdel.putExtra("Ijabatan", Sjabatan);
